...
2
    ...
    function printLevels() {
        console.log(`fulllevels:`, fullLevels)
        // fullLevels.forEach((level, i) => {
        //     console.log(`FullLevel ${i}: [ ${level.map(x => x.toString()).join(", ")} ]`)
        // })

        console.log(`levels:`, levels)
        // levels.forEach((level, i) => {
        //     console.log(`Level ${i}: [ ${level.map(x => x.toString()).join("| ")} ]`)
        // })
    ...
    return { add, indexOf, build, printLevels }
}
